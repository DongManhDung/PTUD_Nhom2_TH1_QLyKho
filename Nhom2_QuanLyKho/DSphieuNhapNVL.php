...
<!------------------------------------------------Tạo nội dung--------------------------------------------------->
            <div class="body_section_inner_right">
                <h3>Danh sách phiếu nhập nguyên vật liệu</h3>
                <div class="col-md-12" >
                ...
                <table class="table-one">
                    ...
                    <tbody>
                        ...
                        $query="SELECT * FROM  chitietphieunhapnvl x inner join phieunhapkho y on x.MaPhieuNhapKho = y.MaPhieuNhapKho";
