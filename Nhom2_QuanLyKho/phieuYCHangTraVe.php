...
<head>
    ...
    <title>Phiếu Yêu Cầu Hàng Trả Về</title>
                    ...
                    <ul>
                        <li><i class="fa-solid fa-chart-simple"></i><a href="#"  id="color_highlight">Báo cáo</a></li>
                            <ul class="navbar_fix1">
                                <li><a href="index.php?page_layout=phieudonhangtrave"  id="color_highlight">Phiếu đơn hàng trả về</a></li>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th>22/09/2023</th>
                                    <th>22092301</th>
                                    <th>Cung cấp vượt quá quá 10% số lượng order</th>
                                    <th>MD0509</th>
                                    <th>trả hàng về trước ngày 24/09/2023</th>
                                    <th>AnhMoi</th>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="modal-body">
                        <form role="form" class="form-control">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input id="txtSCMND" type="text" placeholder="Nhập Mã Phiếu" class="form-control">
                                    <span id="tbSCMND" class="text-danger">*</span><br>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <label><b>TT Trả về</b> </label>
                                </div>
                                <div class="col-md-8">
                                    <input id="txtQQ" type="text" placeholder="Nhập thông tin trả về" class="form-control">
