...
<!------------------------------------------------Tạo nội dung--------------------------------------------------->
            <div class="body_section_inner_right">
                <h3>Danh sách phiếu xuất sản phẩm</h3>
                <div class="col-md-12" >
                ...
                <table class="table-one">
                    ...
                    <tbody>
                        ...
                        $query="SELECT * FROM  chitietphieuxuatsanpham x inner join phieuxuatkho y on x.MaPhieuXuatKho = y.MaPhieuXuatKho";
