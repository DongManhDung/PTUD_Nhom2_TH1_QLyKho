...
?>
<?php
    if(isset($_POST["dieuPhoiNhapNVL"])){
        $tennvl = $_POST["TenNVL"];
        $soluong = $_POST["SoLuong"];
        $dungluong = $_POST["DungLuong"];


        $sql_dieuphoinhapnvl = "INSERT INTO `dieuphoinhapnvl`(`TenNVL   `, `SoLuong`, `DungLuong`) VALUES ('$nguyenvatlieu','$soluong','$dungluong')";
        mysqli_query($mysqli,$sql_dieuphoinhapnvl);
...
?>
 <!DOCTYPE html>
    ...
    <head>
        ...
        <title>Điều phối nhập NVL</title>
        <!-- Add CSS styles -->
...
<div class="body_section_inner_right">
        <div class="text_inner_right">
            <h2>ĐIỀU PHỐI NHẬP NGUYÊN VẬT LIỆU</h2><br>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <div class="form_group_inner_label_input">
                                    <label for="txtMaDpnnvl">Mã phiếu :</label>
                                    <input type="text" name="MaDpnnvl" placeholder="Mã tự tăng dần" readonly>
                                </div>
