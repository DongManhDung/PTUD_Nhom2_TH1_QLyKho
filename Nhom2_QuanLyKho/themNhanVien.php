...
<?php
    if(isset($_POST["themnhanvienmoi"])){
        $hotennv = $_POST["HoTen"];
                    ...
                    <form action="" method="POST" class="warehouse_from_inner">
                        ...
                        <div class="warehouse_form-group">
                            <div class="form_group_inner">
                                ...
                                <span id="tbMaNhanVien" class="warning">*</span>   
                            </div>    
                            ...
                            <div class="form_group_inner">
                                ...
                                <span id="tbTenNhanVien" class="warning">*</span>   
                            </div>                       
                        </div>
                        ...
                        <div class="warehouse_form-group">
                                <div class="form_group_inner">
                                    <div class="form_group_inner_label_input">
                                        ...
                                        <input type="text" name="ViTriLamViec" placeholder="">
                                    </div> 
                                        <span id="tbViTri" class="warning">*</span>    
                                </div> 
                            ...
                            <div class="form_group_inner">
                                <div class="form_group_inner_label_input">
                                    ...
                                    <input type="text" name="NgaySinh" placeholder="yyyy-MM-dd">
                                </div>
                                <span id="tbNgaySinh" class="warning">*</span>  
                            </div>                   
                        </div>
                        ...
                        <div class="warehouse_form-group">
                            <div class="form_group_inner">
                                ...
                                <span id="tbGioiTinh" class="warning">*</span>   
                            </div>    
                        ...
                        <div class="warehouse_form-group">
                            <div class="form_group_inner">
                                ...
                                <span id="tbSDT" class="warning">*</span>   
                            </div>                       
                        ...
                        <div class="submit">
                            <a class="btn_submit" id="btn_fix" href="dsNhanVien.html">Quay lại</a>
