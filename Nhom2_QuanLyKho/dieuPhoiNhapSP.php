...
?>
<?php
    if(isset($_POST["dieuPhoiNhapSP"])){
        $tenSP = $_POST["TenSP"];
        $soluong = $_POST["SoLuong"];
        $dungluong = $_POST["DungLuong"];


        $sql_dieuphoinhapsp = "INSERT INTO `dieuphoinhapsp`(`TenSP `, `SoLuong`, `DungLuong`) VALUES ('$tensanpham','$soluong','$dungluong')";
...
<div class="navbar">
                    <ul>
                        ...
                        <ul class="navbar_fix1">
                            ...
                            <li><a href="index.php?page_layout=dieuphoinhapsp"  id="color_highlight">Điều phối nhập sản phẩm</a></li>
...
<div class="body_section_inner_right">
    <div class="text_inner_right">
        <h2>ĐIỀU PHỐI NHẬP SẢN PHẨM</h2><br>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <div class="form_group_inner_label_input">
                                    <label for="txtMaDpnsp">Mã phiếu :</label>
                                    <input type="text" name="MaDpnsp" placeholder="Mã tự tăng dần" readonly>
                                </div>
